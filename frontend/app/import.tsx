/**
 * Import screen — pick a Hevy CSV/JSON export, preview parsed counts, then
 * upload it to POST /api/v1/import?source=hevy. Three states drive the layout
 * via local `step`: file_pick -> preview -> progress (which auto-flips to
 * 'success' when the request resolves, or 'error' on failure).
  ...
  return (
    <View style={styles.pickWrap}>
      <View style={styles.dropzone}>
        ...
        <Text style={styles.dropzoneTitle}>Choose a CSV or JSON export</Text>
    ...
    <View style={styles.previewWrap}>
      ...
      {parse && !parse.supported && (
        <Text style={styles.parseHint}>
          Preview unavailable for this file type. Ready to import.
        </Text>
      )}
