/**
 * Per-day session-intensity heatmap for the History screen — a port of
 * `activity_map` (backend/app/api/misc.py). Covers the last N weeks up to today,
 * intensity capped at 3. Local time authoritative. Pure; node --test runs it.
 */
